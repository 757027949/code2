package com.asd.android.widget.viewbadger;
...
public class BadgeView extends TextView {
    ...
    public static final int POSITION_CENTER_VERTICAL_LEFT = 6;
    public static final int POSITION_CENTER_VERTICAL_RIGHY = 7;
    ...
    private void applyLayoutParams() {
        ...
        switch (badgePosition) {
            ...
            case POSITION_CENTER_VERTICAL_LEFT:
                ...
                break;
            case POSITION_CENTER_VERTICAL_RIGHY:
