...
import com.asd.android.util.ViewUtils;
import com.asd.android.view.HightLightView;
...
public class HighLight {
    public static class ViewPosInfo {
         ...
         * 矩形
         */
        public static final int DRAW_STYLE_RECT = 0;
        /**
         * 圆
         */
        public static final int DRAW_STYLE_CIRCLE = 1;
        public int drawStyle = DRAW_STYLE_RECT;
    }
    ...
    public HighLight addHighLight(int viewId, int decorLayoutId, int dramStyle, OnPosCallback onPosCallback) {
        ViewGroup parent = (ViewGroup) mAnchor;
        View view = parent.findViewById(viewId);
        addHighLight(view, decorLayoutId, dramStyle, onPosCallback);
        return this;
    }
...
//            if (!rect.equals(viewPosInfo.rectF))//TODO bug dismissed...fc...
    ...
    public HighLight addHighLight(View view, int decorLayoutId, int dramStyle, OnPosCallback onPosCallback) {
        ViewGroup parent = (ViewGroup) mAnchor;
        ...
        viewPosInfo.drawStyle = dramStyle;
