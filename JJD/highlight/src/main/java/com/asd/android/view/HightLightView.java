...
//            }
    ...
    private void buildMask() {
        ...
        for (HighLight.ViewPosInfo viewPosInfo : mViewRects) {
            if (viewPosInfo.drawStyle == HighLight.ViewPosInfo.DRAW_STYLE_CIRCLE) {
                canvas.drawCircle(viewPosInfo.rectF.right - (viewPosInfo.rectF.right - viewPosInfo.rectF.left) / 2
                        , viewPosInfo.rectF.bottom - (viewPosInfo.rectF.bottom - viewPosInfo.rectF.top) / 2,
                        (viewPosInfo.rectF.bottom - viewPosInfo.rectF.top) / 2, mPaint);
            } else {
