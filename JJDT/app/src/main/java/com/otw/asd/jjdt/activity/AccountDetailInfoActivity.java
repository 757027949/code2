    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case SET_ACCOUNTORDERDETAIL:
                ...
                current_money.setText(accountDetailInfo.getAccountOrderCurrentAmount() + "");
                break;
        }
        return false;
    }
...
//        Logger.e("RecordActivity...");
    ...
    public void initView(View view) {
        ...
        if ("withdrawal".equals(flow) || "accountDetail".equals(flow)) {//withdrawal：提现  accountDetail:明细
