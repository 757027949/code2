...
import com.otw.asd.jjdt.activity.LoginActivity;
...
public abstract class BaseActivity extends Activity implements IBaseActivity, Handler.Callback {
    ...
    OnSessionStatusListener onSessionStatusListener;

    protected final int FLOW_SESSION = -505;
    /**
     * 是否取消请求
     */
    protected boolean okhttpCancel = true;
...
//                if (null != LocalCache.get(this).getAsObject(LocalCacheKey.KEY_USER)) {
    ...
    public OnSessionStatusListener getOnSessionStatusListener() {
        return onSessionStatusListener;
    }
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsonObject.getBoolean("success")) {
                                        if (null != onSessionStatusListener) {
                                            onSessionStatusListener.getSessionStaus(true);
                                        }
                                        ...
                                        if (null != onSessionStatusListener) {
                                            onSessionStatusListener.getSessionStaus(false);
                                        }
...
//                                    MyDialog.getInstance(BaseActivity.this).getWaringAlertDialog(getResString(R.string.json_error)).show();
    ...
    public interface OnSessionStatusListener {
         ...
         * 获取session状态
         *
         * @param status true:获取成功 false：反之
         */
        void getSessionStaus(boolean status);
    }
