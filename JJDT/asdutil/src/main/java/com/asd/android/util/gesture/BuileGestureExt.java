...
public class  BuileGestureExt  {
    ...
    public BuileGestureExt(Context c,OnGestureResult onGestureResult) {
        ...
        this.xlimit=screen.widthPixels / 7;
        this.ylimit=screen.heightPixels / 7;
    }
    ...
    public BuileGestureExt setXlimit(float xlimit) {
        this.xlimit = xlimit;
        return this;
    }
    ...
    public BuileGestureExt setYlimit(float ylimit) {
        this.ylimit = ylimit;
        return this;
    }
    ...
    private GestureDetector.OnGestureListener onGestureListener = new GestureDetector.SimpleOnGestureListener(){
        ...
        public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
            ...
            //限制必须得划过屏幕的1/4才能算划过
            float x_limit = xlimit;
            float y_limit = ylimit;
